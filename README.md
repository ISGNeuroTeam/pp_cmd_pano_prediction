# pp_cmd_pano_prediction
Postprocessing command "pano_prediction"
...
### Test pano_prediction
Use `pp` to test pano_prediction command:  
```bash
pp
Storage directory is /tmp/pp_cmd_test/storage
Commmands directory is /tmp/pp_cmd_test/pp_cmd
query: | otl_v1 <# makeresults count=100 #> |  pano_prediction 
```
